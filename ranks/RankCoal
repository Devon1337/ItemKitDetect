...
public class RankCoal {
	
	public void openCoalGUI(Player player) {
		Inventory inv = Bukkit.createInventory(null, 18, ChatColor.GREEN + "Do you want to open it? [Kit Coal]");
