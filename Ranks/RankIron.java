...
public class RankIron {

	public void openIronGUI(Player player) {
		Inventory inv = Bukkit.createInventory(null, 18, ChatColor.GREEN + "Do you want to open it? [Iron Kit]");
