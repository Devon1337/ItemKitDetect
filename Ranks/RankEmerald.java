...
public class RankEmerald {
	public void openEmeraldGUI(Player player) {
		Inventory inv = Bukkit.createInventory(null, 18, ChatColor.GREEN + "Do you want to open it? [Emerald Kit]");
