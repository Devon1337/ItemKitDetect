...
public class RankLapis {
	public void openLapisGUI(Player player) {
		Inventory inv = Bukkit.createInventory(null, 18, ChatColor.GREEN + "Do you want to open it? [Lapis Kit]");
